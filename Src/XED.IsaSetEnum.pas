...
/// @ingroup ENUM
function str2xed_isa_set_enum_t(s: PAnsiChar): TXEDIsaSetEnum;  cdecl; external 'xed.dll';
/// This converts strings to #xed_isa_set_enum_t types.
/// @param p An enumeration element of type xed_isa_set_enum_t.
/// @return string
/// @ingroup ENUM
function xed_isa_set_enum_t2str(const p: TXEDIsaSetEnum): PAnsiChar; cdecl; external 'xed.dll';

/// Returns the last element of the enumeration
/// @return xed_isa_set_enum_t The last element of the enumeration.
/// @ingroup ENUM
function xed_isa_set_enum_t_last:TXEDIsaSetEnum;cdecl; external 'xed.dll';
