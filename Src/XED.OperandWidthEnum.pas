...
/// @ingroup ENUM
function str2xed_operand_width_enum_t(s: PAnsiChar): TXED_Operand_Width_Enum;  cdecl; external 'xed.dll';
/// This converts strings to #xed_operand_width_enum_t types.
/// @param p An enumeration element of type xed_operand_width_enum_t.
/// @return string
/// @ingroup ENUM
function xed_operand_width_enum_t2str(const p: TXED_Operand_Width_Enum): PAnsiChar; cdecl; external 'xed.dll';

/// Returns the last element of the enumeration
/// @return xed_operand_width_enum_t The last element of the enumeration.
/// @ingroup ENUM
function xed_operand_width_enum_t_last:TXED_Operand_Width_Enum;cdecl; external 'xed.dll';
